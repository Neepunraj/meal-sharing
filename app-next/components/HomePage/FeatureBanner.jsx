        ...
        <section className={styles.relativeSection}>
            <div className={`${styles.imgDisplay} ${styles.activeImg}`}>
                <div className={styles.absolutediv}>
                    <Image src={'https://res.cloudinary.com/dtm7wbzin/image/upload/v1752348159/mealphoto/szkdq0tqsf7kxzenatme.webp'} fill alt={`Banner raya`} className={styles.imageBanner} />
                </div>
